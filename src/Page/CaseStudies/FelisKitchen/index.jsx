...
function FelisKitchenCaseStudyPage() {
    return (
        <div className="voss-page-wrapper">
            <HeadTitle title="Felis Kitchen Case Study - McCollins Media - Digital Marketing Agency" />
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 pr-lg-5">
                            <AnimateOnScroll animation="fadeInLeft" speed="normal">
                                <div>
                                    <h1 className="voss-hero-title-main">felis</h1>
                                    <h2 className="voss-hero-title-sub">kitchen</h2>
            ...
            <div className="voss-kpi-section">
                <div className="hero-container position-relative">
                    <div className="voss-section-header">
                        ...
                        <span className="voss-label-right">FELIS KITCHEN</span>
                    </div>
...
export default FelisKitchenCaseStudyPage;