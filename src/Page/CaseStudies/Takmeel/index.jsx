...
function TakmeelCaseStudyPage() {
    return (
        <div style={{ backgroundColor: 'var(--background-color)' }}>
            ...
            <InnerNew desktopImage="/assets/images/case-studies/oakberry/banner.jpg" mobileImage="/assets/images/case-studies/oakberry/banner.jpg" title="Takmeel" title2="Case Study" title3="" />
