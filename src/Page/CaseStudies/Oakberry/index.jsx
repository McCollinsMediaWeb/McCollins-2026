...
function OakberryCaseStudyPage() {
    return (
        <div style={{ backgroundColor: 'var(--background-color)' }}>
            ...
            <InnerNew desktopImage="/assets/images/case-studies/oakberry/banner.jpg" mobileImage="/assets/images/case-studies/oakberry/banner.jpg" title="Oakberry" title2="Case Study" title3="" />
