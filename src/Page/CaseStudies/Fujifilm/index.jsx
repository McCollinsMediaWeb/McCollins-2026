...
function FujifilmCaseStudyPage() {
    return (
        <div style={{ backgroundColor: 'var(--background-color)' }}>
            <HeadTitle title="Fujifilm Case Study - McCollins Media - Digital Marketing Agency" />
            <InnerNew desktopImage="/assets/images/case-studies/oakberry/banner.jpg" mobileImage="/assets/images/case-studies/oakberry/banner.jpg" title="FujiFilm" title2="Case Study" title3="" />
...
export default FujifilmCaseStudyPage;