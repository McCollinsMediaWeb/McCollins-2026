...
function CreamioCafeCaseStudyPage() {
    return (
        <div className="voss-page-wrapper">
            <HeadTitle title="Creamio Cafe Case Study - McCollins Media - Digital Marketing Agency" />
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 pr-lg-5">
                            <AnimateOnScroll animation="fadeInLeft" speed="normal">
                                <div>
                                    <h1 className="voss-hero-title-main">creamio</h1>
                                    <h2 className="voss-hero-title-sub">cafe</h2>
            ...
            <div className="voss-blue-bar">
                <div className="hero-container">
                    <div className="voss-blue-bar-content">
                        <span>CREAMIO CAFE</span>
                        <span>CASE STUDY</span>
                        <span>BRAND MARKETING REBUILT</span>
                    </div>
                </div>
            </div>
            ...
            <div className="voss-kpi-section">
                <div className="hero-container position-relative">
                    <div className="voss-section-header">
                        ...
                        <span className="voss-label-right">CREAMIO CAFE</span>
                    </div>
...
export default CreamioCafeCaseStudyPage;