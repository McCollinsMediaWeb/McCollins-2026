...
function CreamioCafeCaseStudyPage() {
    return (
        <div style={{ backgroundColor: 'var(--background-color)' }}>
            ...
            <InnerNew desktopImage="/assets/images/case-studies/oakberry/banner.jpg" mobileImage="/assets/images/case-studies/oakberry/banner.jpg" title="Creamio Cafe" title2="Case Study" title3="" />
