...
function VossDubaiCaseStudyPage() {
    return (
        <div className="voss-page-wrapper">
            <HeadTitle title="Voss Dubai Case Study - McCollins Media - Digital Marketing Agency" />
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 pr-lg-5">
                            <AnimateOnScroll animation="fadeInLeft" speed="normal">
                                <div>
                                    <h1 className="voss-hero-title-main">voss</h1>
                                    <h2 className="voss-hero-title-sub">Waters</h2>
            ...
            <div className="voss-blue-bar">
                <div className="hero-container">
                    <div className="voss-blue-bar-content">
                        <span>VOSS WATERS</span>
                        <span>CASE STUDY</span>
                        <span>LUXURY COMMERCE REBUILT</span>
                    </div>
                </div>
            </div>
            ...
            <div className="voss-kpi-section">
                <div className="hero-container position-relative">
                    <div className="voss-section-header">
                        ...
                        <span className="voss-label-right">VOSS WATERS</span>
                    </div>
...
export default VossDubaiCaseStudyPage;