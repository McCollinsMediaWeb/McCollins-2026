...
function BrandDevelopment() {
    return (
        <>
            ...
            <InnerNew desktopImage="/assets/images/servicemaindesk.jpg" mobileImage="/assets/images/servicemainmob.jpg" title="A Brand" title2="Ecosystem of " title3="Digital Excellence." />
            <HeaderLayout />
