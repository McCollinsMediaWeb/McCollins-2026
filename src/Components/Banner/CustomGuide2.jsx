                            ...
                            <div className="guide-content" style={{ maxWidth: 'unset' }}>
                                <div className="d-flex flex-column gspace-2">
                                    ...
                                    <div className="d-block d-md-none" >
                                        <p style={{ fontWeight: 100, color: '#adadad' }}>Strategy-led design defines every brand we architect. By translating your vision into a precise and memorable visual identity, we ensure your brand excels in recognition and delivers significant, measurable results.</p>
                                    ...
                                    <div className="d-none d-md-flex" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'end', flexDirection: 'row-reverse' }} >
